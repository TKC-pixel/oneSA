...
<<<<<<< HEAD
          ...
          const allProjects = ministersData.flatMap(
            (minister) =>
              (minister.ministerDepartment &&
                minister.ministerDepartment.projects) ||
              []
          );
...
>>>>>>> b3d7e7b4b1b9b5a4caf01baa3599f8dcc1169467
          ...
          const sortedProjects = allProjects.sort(
            (a, b) =>
              new Date(b.projectStartDate) - new Date(a.projectStartDate)
          );
  ...
  const handleLikeProject = async (project) => {
    ...
    const isAlreadyLiked = userData.favorites?.some(
      (fav) => fav.projectName === project.projectName
    );
  ...
  return (
    ...
    >
      <TextInput
        style={
          theme === "light" ? styles.searchInput : darkModeStyles.searchInput
        }
            ...
            <View
              style={
                theme === "light"
                  ...
                  : darkModeStyles.projectContainer
              }
            >
              <TouchableOpacity
              ...
              <TouchableOpacity
                onPress={() => handleLikeProject(project)}
