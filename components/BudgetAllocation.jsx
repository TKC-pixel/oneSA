  ...
  const displayData = () => {
    ...
    const mappings = {
      ...
      "Fruitless & Wasteful Expenditure":
        "Fruitless & Wasteful Expenditure           R ",
      "Posts Approved":
        "Posts Approved                                         R ",
      "Posts Filled":
        "Posts Filled                                                  R ",
    ...
    if (auditOutcomeMatch) {
      auditOutcomes = auditOutcomeMatch[1].match(
        /(Financially Unqualified|Clean Audit|Qualified Audit|Adverse Audit)/g
      );
    }
    ...
    return (
      <View style={{ backgroundColor: theme == "light" ? "white" : "black" }}>
        <Text
          style={theme == "light" ? styles.headings : darkModeStyles.headings}
        >
          {outputHeading}
        </Text>
        <Text style={theme == "light" ? styles.budget : darkModeStyles.budget}>
          {output}
        </Text>
        <Text
          style={theme == "light" ? styles.headings : darkModeStyles.headings}
    ...
    >
      <ScrollView style={{ flex: 1, padding: 4}}>
        ...
        >
          ...
          -
          {current
            ? current.replace(/\b\w/, (char) => char.toUpperCase())
